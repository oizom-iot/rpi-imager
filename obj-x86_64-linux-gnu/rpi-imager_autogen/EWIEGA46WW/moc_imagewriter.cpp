...
QT_MOC_LITERAL(86, 1094, 6), // "pbkdf2"
QT_MOC_LITERAL(87, 1101, 3) // "psk"
...
static const uint qt_meta_data_ImageWriter[] = {
 ...
 // signals: name, argc, parameters, tag, flags
       ...
       5,    2,  339,    2, 0x06 /* Public */,
       8,    1,  344,    2, 0x06 /* Public */,
      10,    0,  347,    2, 0x06 /* Public */,
 ...
 // slots: name, argc, parameters, tag, flags
      17,    0,  357,    2, 0x09 /* Protected */,
      18,    0,  358,    2, 0x09 /* Protected */,
      19,    0,  359,    2, 0x09 /* Protected */,
      20,    0,  360,    2, 0x09 /* Protected */,
      21,    0,  361,    2, 0x09 /* Protected */,
      22,    0,  362,    2, 0x09 /* Protected */,
      23,    1,  363,    2, 0x09 /* Protected */,
      24,    1,  366,    2, 0x09 /* Protected */,
      25,    0,  369,    2, 0x09 /* Protected */,
      26,    1,  370,    2, 0x09 /* Protected */,
      28,    0,  373,    2, 0x09 /* Protected */,
      29,    1,  374,    2, 0x09 /* Protected */,
      32,    1,  377,    2, 0x09 /* Protected */,

 // methods: name, argc, parameters, tag, flags
      33,    7,  380,    2, 0x02 /* Public */,
      33,    6,  395,    2, 0x22 /* Public | MethodCloned */,
      33,    5,  408,    2, 0x22 /* Public | MethodCloned */,
      33,    4,  419,    2, 0x22 /* Public | MethodCloned */,
      33,    3,  428,    2, 0x22 /* Public | MethodCloned */,
      33,    2,  435,    2, 0x22 /* Public | MethodCloned */,
      33,    1,  440,    2, 0x22 /* Public | MethodCloned */,
      41,    2,  443,    2, 0x02 /* Public */,
      41,    1,  448,    2, 0x22 /* Public | MethodCloned */,
      44,    1,  451,    2, 0x02 /* Public */,
      46,    0,  454,    2, 0x02 /* Public */,
      47,    0,  455,    2, 0x02 /* Public */,
      48,    0,  456,    2, 0x02 /* Public */,
      49,    2,  457,    2, 0x02 /* Public */,
      50,    0,  462,    2, 0x02 /* Public */,
      51,    0,  463,    2, 0x02 /* Public */,
      52,    1,  464,    2, 0x02 /* Public */,
      53,    0,  467,    2, 0x02 /* Public */,
      54,    0,  468,    2, 0x02 /* Public */,
      55,    1,  469,    2, 0x02 /* Public */,
      57,    1,  472,    2, 0x02 /* Public */,
      58,    0,  475,    2, 0x02 /* Public */,
      59,    0,  476,    2, 0x02 /* Public */,
      60,    0,  477,    2, 0x02 /* Public */,
      61,    0,  478,    2, 0x02 /* Public */,
      62,    0,  479,    2, 0x02 /* Public */,
      63,    0,  480,    2, 0x02 /* Public */,
      64,    0,  481,    2, 0x02 /* Public */,
      65,    0,  482,    2, 0x02 /* Public */,
      66,    0,  483,    2, 0x02 /* Public */,
      67,    0,  484,    2, 0x02 /* Public */,
      68,    0,  485,    2, 0x02 /* Public */,
      69,    1,  486,    2, 0x02 /* Public */,
      71,    1,  489,    2, 0x02 /* Public */,
      73,    2,  492,    2, 0x02 /* Public */,
      75,    3,  497,    2, 0x02 /* Public */,
      79,    1,  504,    2, 0x02 /* Public */,
      81,    0,  507,    2, 0x02 /* Public */,
      82,    0,  508,    2, 0x02 /* Public */,
      83,    0,  509,    2, 0x02 /* Public */,
      84,    1,  510,    2, 0x02 /* Public */,
      86,    2,  513,    2, 0x02 /* Public */,
 ...
 // methods: parameters
    ...
    QMetaType::QString, QMetaType::QByteArray, QMetaType::QByteArray,   87,   70,
...
void ImageWriter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 62: { QString _r = _t->crypt((*reinterpret_cast< const QByteArray(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 63: { QString _r = _t->pbkdf2((*reinterpret_cast< const QByteArray(*)>(_a[1])),(*reinterpret_cast< const QByteArray(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
