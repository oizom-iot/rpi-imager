...
ApplicationWindow {
    ...
    title: qsTr("Oizom Imager v%1").arg(imageWriter.constantVersion())
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            Image {
                ...
                source: window.height > 700 ? "icons/oizom2-hires.png" : "icons/oizom2.png"
                width: window.width
            ...
            GridLayout {
                ...
                ColumnLayout {
                    ...
                    Button {
                        ...
                        Material.foreground: "#2CAF96"//c51a4a
...
//                      visible: !icon
    ...
    MsgPopup {
        ...
        text: qsTr("Oizom Imager is still busy.<br>Are you sure you want to quit?")
        onYes: {
            Qt.quit()
        }
    }
